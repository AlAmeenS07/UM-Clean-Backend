...
import { ALL_FIELDS_REQUIRED, COOKIE_TOKEN, EMAIL_AND_PASSWORD_REQUIRED, INVALID_EMAIL, LOGIN_SUCCESSFULLY, LOGOUT_SUCCESSFULLY, PASSWORD_MUST_6_LETTER, UNEXPECTED_TOKEN_ERROR, USER_FETCHED, USER_NOT_FOUND_WITH_EMAIL, USER_REGISTERED_SUCCESSFULLY } from "../utils/constants";
...
export class UserController {
  ...
  profile = async (req: Request, res: Response) => {
    try {
      ...
      let user = await this._userService.userData(email)
