...
export const USER_ACCOUNT_BLOCKED : string = "User account is blocked"
export const UNAUTHORIZED : string = "Unauthorized !"
export const UNEXPECTED_TOKEN_ERROR : string = "Unexpected token error !"
export const ONLY_ADMIN_CAN_ASSECC : string = "Only admin can access !"
export const USERS_NOT_FOUND : string = "users not found !"
export const USERS_FETCH_SUCCESSFULLY : string = "users fetched successfully"
export const USER_STATUS_UPDATED : string = "user status updated"
export const USER_FETCHED : string = "User fetched successfully"